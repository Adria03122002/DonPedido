...
class PedidoController {
    constructor() {
        ...
        this.lineaRepo = data_source_1.AppDataSource.getRepository(LineaPedido_1.LineaPedido);
     ...
     */
    async getPedidosActivos(req, res) {
        try {
    ...
    async getPedidoActivoPorMesa(req, res) {
